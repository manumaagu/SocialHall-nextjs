            ...
            <section>
              <div className="text-center m-top">
                ...
                <h2 className="text-4xl">
                  ...
                  platform. From scheduling posts to engaging with your
                ...
                <div className="flex flex-col">
                  ...
                  <div className="my-4">
                    ...
                    <h4 className="text-xl">
                      {" "}
                      Plan your content calendar and publish posts at the
                      perfect time.{" "}
                    </h4>
                  </div>
                  ...
                  <div className="my-4">
                    ...
                    <h4 className="text-xl">
                      {" "}
                      Track engagement, follower growth, and post performance
